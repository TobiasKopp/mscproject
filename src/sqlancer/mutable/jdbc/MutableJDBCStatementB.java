...
public class MutableJDBCStatementB extends MutableJDBCAbstractStatement  {

	MutableJDBCStatementB(MutableJDBCAbstractConnection connection, boolean debug)  {
	...
	public boolean execute(String sql) throws SQLException {
    	...
    	if (debug) System.out.println("MutableJDBCStatementB#execute(): " + sql);
    ...
    public ResultSet executeQuery(String query) throws SQLException {
		...
		if (debug) System.out.println("MutableJDBCStatementB#executeQuery(): " + query);
    ...
    private ResultSet executeSelect(String query) throws SQLException {
    	if (debug) System.out.println("MutableJDBCStatementB#exexuteSelect() : " + query);
